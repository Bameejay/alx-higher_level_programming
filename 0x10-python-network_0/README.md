...
In this project, `curl` was used in Bash scripts to send diverse types
of HTTP headers. In the process, This showed me how URL's work, domain names,
and diverse HTTP request/repsonse header fields and status codes.
